 ...
 */
  ...
  public class CategoriesNegocio extends NegocioDesacoplado {
	protected Log log = LogServiceLocator.getDefaultImplementation().getLog(CategoriesNegocio.class);
	
	public static final DtoMeta DTO_META = new DtoMeta(DemoResolusor.getSingleton().getContenedorDeDtoMeta(), "categories",  Categories.class, 	
			new DtoPropiedadMeta[]{
        new DtoPropiedadMeta(CategoriesDao.CATEGORY,"category",DtoPropiedadMeta.DATO_LLAVE , 10) 
     ,  new DtoPropiedadMeta(CategoriesDao.CATEGORYNAME,"categoryname",DtoPropiedadMeta.NO_NULL , 50) 
	       },
	...
	public CategoriesDao getCategoriesDao() {
		if(categoriesDao == null){
			categoriesDao = (CategoriesDao)getDao();
		}
