...
<fmt:bundle basename="com.persistence.dpph.resourceBundle.MessagesResources">
...
<link href="${ctx}/include/styles/ria/jquery-ui.css" rel="stylesheet">
...
<link href="${ctx}/include/styles/ria/jquery.datepicker.min.css" rel="stylesheet">
...
<link rel="stylesheet" type="text/css" href="${ctx}/include/styles/ria/jquery-ui-timepicker-addon.css"/>
...
<script type="text/javascript" language="javascript" src="${ctx}/include/scripts/ria/jquery-ui-1.9.2.custom.min.js"></script>
<script type="text/javascript" lenguaje="javascript" src="${ctx}/include/scripts/ckeditor/ckeditor.js"></script>
...
<script type="text/javascript" language="javascript" src="${ctx}/include/scripts/ria/jquery-ui-timepicker-addon.js"></script>
<script type="text/javascript" language="javascript" src="${ctx}/include/scripts/ria/jquery-ui-timepicker-addon.min.js"></script>
...
<script>
	...
	function mostrarDialogoGeneral(message){
		dialogGeneric();
		$( "#dialog-message-generic" ).empty();
		$( "#dialog-message-generic" ).append(message);
...
// 		doSubmit<c:if test="${ not empty detalle.cabecera || ubicacion == 'cabecera' || not empty esAsync}">Async</c:if>(action);
	...
	function formarListado(){
		...
		$('#action-bar').buttonset().css({'display':'block','width':'60%', 'float':'left'});
		$('#navigation-bar').buttonset().css({'text-align':'right','display':'block','width':'35%', 'float':'right', 'margin-left':'0px'});
